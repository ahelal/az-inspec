...
class AzBasic < Inspec.resource(1)
  ...
  def initialize(subcommand, list = nil, resource_name = nil, resource_group = nil, extra_args = nil, subscription = nil)
    ...
    command = "#{command} --subscription '#{subscription}'" if subscription
